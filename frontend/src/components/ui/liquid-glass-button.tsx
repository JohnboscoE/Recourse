...
/**
 * NOTE: the frosted-glass distortion comes from `backdrop-filter: url(#…)`,
 * which only Chromium honours. Firefox and Safari drop the distortion and
 * render the button flat — it stays legible and clickable, just less fancy.
 * Worth knowing if the demo video is recorded outside Chrome.
 */
